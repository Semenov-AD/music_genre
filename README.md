...
pandas, scikit-learn, imbalanced-learn, catboost, shap.  

Вывод по проекту:  
Были исследованы модели линейной регрессии, слйчайного леса и градиентного бустинга. На валидационной выборке лучший результат показал градиентный бустинг, значение метрики f1-macro = 0.66.  
Наиболее значимые признаки: popularity, instrumentalness, danceability, speechiness, acousticness.